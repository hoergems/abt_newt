...
public:
    ...
    virtual void updateModel(StepResult &stepResult, std::vector<State const *> &particles);
    ...
    virtual solver::StateInfo * sampleParticle(const std::vector<solver::StateInfo *> &stateInfos);
